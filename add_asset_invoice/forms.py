...
class AssetInvoiceForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            #'total_invoice_cost': forms.TextInput(attrs={'class': 'form-control', 'readonly': 'readonly'}),
...
class CustomPasswordChangeForm(PasswordChangeForm):
    def __init__(self, *args, **kwargs):
        ...
        # قم بإلغاء القواعد التي تريد تجاهلها
        self.fields['new_password1'].validators = []
        self.fields['new_password2'].validators = []


        # تخصيص قواعد أخرى إذا لزم الأمر
        self.fields['new_password1'].widget.attrs['placeholder'] = 'اختر كلمة مرور جديدة'
